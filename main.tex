...
\begin{figure}[H]
    ...
    \subfigure[Linear and Mixed Model Summary Table]{
        \includegraphics[width=0.8\textwidth]{lmvslmmtable.png}
        \label{fig:lmvslmmtable}
        \vspace{0.5em}
    }

    \subfigure[Partial Effects Plot for the Linear Model]{
        \includegraphics[width=0.8\textwidth]{modelplot_lmvslmm.png}
        \label{fig:lmvslmm}
        \vspace{0.5em}
    }
...
\begin{figure}[H]
    ...
    \subfigure[Additive and Additive Mixed Model AIC Comparison]{
        \includegraphics[width=0.8\textwidth]{Gammtable.png}
        \label{fig:GAMtable}
        \vspace{0.5em}
    }
    \subfigure[Partial Effects from the Reduced Additive Model]{
        \includegraphics[width=0.8\textwidth]{Gamm.png}
        \label{fig:GAMcoplot}
        \vspace{0.5em}
    }
