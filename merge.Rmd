...
df1 <- read.csv("E:\\MPA_project\\data\\Musquash_MPA_Benthos_Infauna.csv", encoding = 'latin1')
df2 <- read.csv("E:\\MPA_project\\data\\Musquash_MPA_Sediment_Grain_Size.csv", encoding = 'latin1')
df3 <- read.csv("E:\\MPA_project\\data\\Musquash_MPA_Sediment_Loss_Ignition.csv", encoding = 'latin1')
df4 <- read.csv("E:\\MPA_project\\data\\Musquash_MPA_Set_Data.csv", encoding = 'latin1')
```
...
```{r}
write.csv(df_merged, "E:\\MPA_project\\MPA_merged.csv", row.names = FALSE)
```
